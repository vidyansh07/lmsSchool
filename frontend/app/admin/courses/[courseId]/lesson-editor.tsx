      ...
      {resources.length > 0 ? (
        <ul className="divide-y divide-line rounded-md border border-line">
          {resources.map((resource) => (
            <li
              key={resource.id}
              className="flex items-center gap-3 px-3 py-2 text-sm transition-colors hover:bg-sunken/40"
            >
        ...
        <p className="text-xs text-ink-muted">No resources attached yet.</p>
      )}
